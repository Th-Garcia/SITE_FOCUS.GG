...
export default function Login() {
  ...
  return <main className="min-h-screen grid lg:grid-cols-2">
    <section className="auth-visual hidden lg:flex relative overflow-hidden p-14 flex-col justify-between"><div className="orb top-[-100px] left-[-100px]"/><Logo/><div className="relative"><p className="eyebrow">Seu progresso começa aqui</p><h1 className="mt-5 text-6xl leading-[.95] tracking-[-.06em] font-black">Treine com<br/><span className="purple">propósito.</span></h1><p className="muted mt-7 max-w-md leading-relaxed">Descubra seu nível, receba treinos orientados e acompanhe sua evolução com clareza.</p></div><p className="muted text-xs">Projeto educacional • SENAC Nações Unidas</p></section>
